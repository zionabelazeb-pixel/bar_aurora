 ...
 * Exactly 2 CTAs: WhatsApp (primary) + Phone (secondary).
 */
...
// CDN URLs for real bar photos
const HERO_BG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663452707407/GFxwXvVrzFksaCXXGMeyQt/bar-counter_b19dff7c.jpg";
...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Dark gradient overlay — ensures white text is readable in sunlight */}
      <div
        style={{
          position: "absolute",
          inset: 0,
